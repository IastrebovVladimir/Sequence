...
Учебный проект по последовательностям на C++.

## Описание

Проект реализует разные варианты последовательностей Sequence (массив, список, битовая последовательность) и набор операций с ними.
